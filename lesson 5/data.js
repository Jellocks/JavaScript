...
const getTemplate = (arr) => {
  const shows = document.getElementById('tvshows');
  ...
  arr.forEach(element => {
    const showItem =
      `
             <div class="card" style="background-image:url(${element.image})">
                      <div class="card-inside">
                          <div class="card-visible">
                              <div class="card-rating">
                                  <div class="star"><img src="./assets/img/rating.svg" alt=""></div>
                                  <div class="number">${element.rating}</div>
                              </div>
                              <p class="card-year">${element.rating}</p>
                          </div>
